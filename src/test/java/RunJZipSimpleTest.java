...
public class RunJZipSimpleTest extends BasicTest {
	
	@Test
	public void runtest() throws IOException, IllegalClassFormatException{
		Class<?> clazz = myjzip.JZipSimple.class;
		...
		MainTransformer mainTrans = new MainTransformer("tracker.properties");
		byte[] instrumentedClass = mainTrans.transform(this.getClass().getClassLoader(), clazz.getCanonicalName(), null, null, rawClass);
